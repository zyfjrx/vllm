...
"""DeepSeekOCR2 processor implementation for vLLM."""
import math
...
from transformers import BatchFeature, LlamaTokenizerFast,AutoProcessor
from transformers.processing_utils import ProcessorMixin

# Configuration constants - align with the model implementation
BASE_SIZE = 1024
IMAGE_SIZE = 768
CROP_MODE = True
MIN_CROPS = 2
MAX_CROPS = 6  # max:6 If your GPU memory is small, it is recommended to set it to 6.
